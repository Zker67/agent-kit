...
`7 类 coding environments` · `14 个 skills` · `可复制配置资产` · `通用项目模板`
...
| **Coding environment 指南** | [`environments/`](./environments/) 按 Codex、Cline、Pi、Claude Code、Gemini、Grok 和 Windsurf 分别说明全局 instructions、运行时配置、skills、工具和验证方式。 |
